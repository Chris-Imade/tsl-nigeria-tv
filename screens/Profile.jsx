...
import { Image, Platform, SafeAreaView, ScrollView, Text, TouchableHighlight, TouchableOpacity, View } from "react-native";
...
const Profile = () => {
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: colors.black }}>
            <View style={{ flex: 1, backgroundColor: colors.black, justifyContent: "center", alignItems: "center", paddingTop: Platform.OS == "android" ? 30 : 30 }}>
                <View className="w-full items-center justify-center">
                    ...
                    />
                        <Text className="text-[13px] text-[#F5F5F5] mt-[12px]">Imade Jephthah</Text>
                    </View>
            ...
            <View style={{ flex: 2, alignItems: "center", width: "100%" }}>
                <View className="w-full px-[16px]">
                    {/* Notification */}
                    <TouchableHighlight onPress={() => navigation.navigate("notification-screen")}>
                        <View style={{
                    ...
                    {/* My List */}
                    <TouchableHighlight onPress={() => navigation.navigate("lists-screen")}>
                        <View style={{
                            backgroundColor: "#1A1A1A",
                            borderRadius: 8,
                            width: "100%",
