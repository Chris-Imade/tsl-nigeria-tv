...
import { Image, SafeAreaView, ScrollView, Text, TextInput, TouchableNativeFeedback, TouchableOpacity, View } from "react-native";
...
const Lists = () => {
    ...
    const filteredList = videoList && videoList.filter((item) => {
