import { View, Text, Image, Animated, Dimensions, TouchableOpacity, TouchableWithoutFeedback } from 'react-native'
...
const DATA = [
  {
    ...
    slimWriteUp: "Enjoy captivating and engaging content that will keep you in your sit."
  },
  {
    id: 2,
    ...
    <View style={{ flex: 1, backgroundColor: colors.black }}>
      ...
      <View>
        ...
        style={{ 
          ...
          <Text style={{ color: colors.black, textAlign: "center", fontFamily: "Stem-Medium", fontSize: 20 }}>Get Started</Text>
        </TouchableOpacity>
